  ...
  return (
    <header className="relative z-10 pt-6 pb-12 px-6 overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-x-0 -top-32 h-64 bg-gradient-to-b from-amber-500/18 via-transparent to-transparent blur-3xl" />
        <div className="absolute right-6 top-10 h-36 w-36 rounded-full bg-amber-500/14 blur-[90px]" />
      ...
      >
        <div className="flex flex-col gap-12 lg:grid lg:grid-cols-[1.3fr_0.8fr] lg:items-end">
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl font-serif italic text-white leading-[1.03] tracking-tight">
                Immersive tasting for <span className="text-amber-300/90">{cafe.name}</span>
              </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                ...
                className={`inline-flex items-center gap-3 px-8 py-4 rounded-2xl font-semibold tracking-wide transition-all duration-500 hover:-translate-y-1 ${
                  activeSection === 'chef'
                    ? 'bg-amber-400 text-black shadow-[0_20px_60px_rgba(245,158,11,0.3)]'
                    : 'glass-liquid text-white hover:bg-white/10'
                }`}
              >
                Chef's Board
          ...
          <div className="relative group">
            <div className="absolute -inset-6 bg-amber-500/10 blur-[80px] opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
            <div className="relative overflow-hidden rounded-[2.5rem] glass-liquid p-1">
              <div className="rounded-[2.2rem] bg-black/40 backdrop-blur-3xl p-8 space-y-8">
                ...
                <div className="space-y-4">
                  <div className="inline-block px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[10px] font-mono tracking-widest uppercase">
                    Now Plating
                  </div>
                ...
                <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                   ...
                   {featuredDish && (
                     <div className="text-right">
                       ...
                       <p className="text-2xl font-mono text-amber-400 font-bold text-glow-amber">₹{featuredDish.price.toFixed(2)}</p>
                     </div>
                   )}
                </div>
              </div>
